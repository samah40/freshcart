        ...
        <tr key={product._id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
         ...
         {product.price} EGP
          ...
          <td className="px-6 py-4">
            ...
            }} className="font-medium text-red-600 dark:text-red-500 hover:underline"><i className="fa-solid fa-trash-can text-2xl hover:scale-125 transition-all duration-100"></i></a>
          </td>
        </tr>
       ))}
      </tbody>
