    ...
    return (
      ...
      <div className="flex items-center gap-3">
        ...
        {userToken ?   <ul className="flex items-center space-x-3 font-semibold">
            <li ><NavLink className="block py-2 px-3 text-[#79797a] rounded hover:bg-[#08ac0a]  duration-300 transition-all " to="">Home</NavLink></li>
            <li ><NavLink className="block py-2 px-3 text-[#79797a] rounded hover:bg-[#08ac0a]  duration-300 transition-all " to="products">Products</NavLink></li>
            <li ><NavLink className="block py-2 px-3 text-[#79797a] rounded hover:bg-[#08ac0a]  duration-300 transition-all " to="categories">Categories</NavLink></li>
            <li ><NavLink className="block py-2 px-3 text-[#79797a] rounded hover:bg-[#08ac0a]  duration-300 transition-all " to="brands">Brands</NavLink></li>
          </ul>: ""}
        </div>
        <div className="flex justify-center gap-3">
          ...
          <ul className="flex justify-center space-x-3 font-semibold">
           {userToken?  <li><span onClick={handlelogout}  className="block py-2 px-3 cursor-pointer text-[#79797a] rounded hover:bg-gray-100 duration-300 transition-all hover:text-green-600">Logout</span></li>:
           <>
            <li><NavLink className="block py-2 px-3 text-[#79797a] rounded hover:bg-gray-100 duration-300 transition-all "  to="login">Login</NavLink></li>
            <li><NavLink className="block py-2 px-3 text-[#79797a] rounded hover:bg-gray-100 duration-300 transition-all "  to="register">Register</NavLink></li>
           </>
           }
